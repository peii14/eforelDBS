  ...
  return (
    <div className="w-full p-5 sm:px-0">
                  ...
                  >
                    {Object.values(contents[i]).map((obj, id) => (
                      ...
                      <td>
                        ...
                        type="button">
                          <div className="mt-1 ml-2 py-1 px-3 bg-primary transition-colors h-max duration-200 hover:bg-primary-HOVER cursor-pointer rounded-full ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="w-6 h-7">
      <                       path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                        ...
                        type="button"
                        >
                        <div className="mt-1.5 ml-3 border-2 duration-300 hover:bg-primary-400 border-primary rounded-full px-3 py-1">
